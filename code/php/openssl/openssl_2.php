...
$base_path = '/home/libo/git/david/code/php/openssl/keys';

/**
 * Point to your config file
 *
 */
define("OPEN_SSL_CONF_PATH", "{$base_path}/openssl_2-openssl.cnf");
/**
 ...
 *
 */
define("OPEN_SSL_PUBKEY_PATH", "{$base_path}/openssl_2-key.pem"); // Public key path
