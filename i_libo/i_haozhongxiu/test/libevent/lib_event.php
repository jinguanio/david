...
class test_event
{
	...
	public function run()
	{
		$array = array('localhost:8000', 'localhost:8001');
		...
		//}
			foreach ($array as $key => $value) {
				...
				$this->__events[$key] = event_new();
				event_set($this->__events[$key], $fp, array($this, 'test'), $key);
				event_base_set($this->__events[$key], $this->__event_base);
				event_add()
			}
	...
	public function test($fp, $flag, $key)
	{
		...
		event_buffer_timeout_set($buffer, 3, 5);
