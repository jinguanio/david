...
" After jsDoc standard
let g:pdv_cfg_CommentHead = "/**"
let g:pdv_cfg_Comment1 = " * "
let g:pdv_cfg_Commentn = " * "
let g:pdv_cfg_CommentTail = " */"
let g:pdv_cfg_CommentSingle = "//"
let g:pdv_cfg_CommentHead1 = "/*"

" Default values
let g:pdv_cfg_Type = "mixed"
let g:pdv_cfg_Package = ""
let g:pdv_cfg_Version = "$Id:$"
let g:pdv_cfg_Author = "2006 Beijing eYou Information Technology Co., Ltd."
let g:pdv_cfg_Copyright = ""
let g:pdv_cfg_License = ""
let g:pdv_cfg_file_desc = "functionality description"
...
" <?php annotation
let g:pdv_re_PHP = '^\s*\(<?php\)$'

" require annotation
let g:pdv_re_REQUIRE = '^\s*\(require_once\)'
...
func! JsDocRange() range
    ...
    while l:line <= l:endLine
        ...
        if (getline(l:line) =~ g:pdv_re_func || getline(l:line) =~ g:pdv_re_attribute || getline(l:line) =~ g:pdv_re_class) && getline(l:line - 1) !~ g:pdv_re_comment
			let l:docLines = 0
			" Ensure we are on the correct line to run JsDoc()
            exe "norm! " . l:line . "G$"
			" No matter what, this returns the element name
            let l:elementName = JsDoc()
...
func! JsDoc()
    ...
    if l:line =~ g:pdv_re_func
        let l:result = JsDocFunc()

    elseif l:line =~ g:pdv_re_attribute
        let l:result = JsDocVar()

    elseif l:line =~ g:pdv_re_class
        let l:result = JsDocClass()

    elseif l:line =~ g:pdv_re_PHP
        let l:result = JsDocJS()

    elseif l:line =~ g:pdv_re_REQUIRE
        let l:result = JsDocREQUIRE()

    else 
        let l:result = JsDocDefault()
...
func! JsDocFunc()
    ...
    let l:scope = JsDocScope(l:modifier, l:funcname)
	...
	while (l:parameters != ",") && (l:parameters != "")
        ...
        if l:paramtype == ""
            let l:paramtype = JsDocType(l:paramdefault)
        endif
...
func! JsDocVar()
    ...
    let l:scope = JsDocScope(l:modifier, l:varname)

    let l:static = g:pdv_cfg_php4always == 1 ? matchstr(l:modifier, g:pdv_re_static) : ""

    let l:type = JsDocType(l:default)
...
func! JsDocScope(modifiers, identifier)
...
func! JsDocJS()
    ...
    " ==============output===================
    " Vim editor set
    exe l:txtBOL . g:pdv_cfg_CommentHead1 . " vim: set expandtab tabstop=4 shiftwidth=4 softtabstop=4 foldmethod=marker:" . g:pdv_cfg_CommentTail . g:pdv_cfg_EOL
    exe l:txtBOL . g:pdv_cfg_EOL

    exe l:txtBOL . g:pdv_cfg_CommentHead . g:pdv_cfg_EOL
	exe l:txtBOL . g:pdv_cfg_Comment1 . g:pdv_cfg_file_desc . g:pdv_cfg_EOL
    exe l:txtBOL . g:pdv_cfg_Commentn . g:pdv_cfg_EOL
    exe l:txtBOL . g:pdv_cfg_Commentn . "@fileOverview" . g:pdv_cfg_EOL
	exe l:txtBOL . g:pdv_cfg_Commentn . "@author " . g:pdv_cfg_Author . g:pdv_cfg_EOL
...
func! JsDocREQUIRE()
    ...
    " ==============output===================
    exe l:txtBOL . g:pdv_cfg_CommentHead1 . " require" . g:pdv_cfg_CommentTail . g:pdv_cfg_EOL
endfunc
